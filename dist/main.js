...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Color = __webpack_require__(/*! ./Color */ 169);
	
	var _Color2 = _interopRequireDefault(_Color);
	
	var _ModelSelector = __webpack_require__(/*! ./ModelSelector */ 174);
	
	var _ModelSelector2 = _interopRequireDefault(_ModelSelector);
	
	var _ColorConverter = __webpack_require__(/*! ../ColorConverter */ 175);
	
	var _ColorConverter2 = _interopRequireDefault(_ColorConverter);
	
	__webpack_require__(/*! ./Main.scss */ 170);
	...
	var Main = function (_Component) {
	    ...
	    function Main(props) {
	        ...
	        _this.converter = new _ColorConverter2.default();
	    ...
	    _createClass(Main, [{
	        key: 'handleConvert',
	        value: function handleConvert(colorObject, model) {
	            this.setState({
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_Color2.default, { rgb: this.state.rgb }),
	                _react2.default.createElement(_ModelSelector2.default, { onConvert: this.hanldeConvert }),
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./../../~/postcss-loader!./../../~/sass-loader!./Main.scss */ 171);
...
/* 171 */
/*!************************************************************************************!*\
  !*** ./~/css-loader!./~/postcss-loader!./~/sass-loader!./src/components/Main.scss ***!
  \************************************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModelSelector = function (_Component) {
	    _inherits(ModelSelector, _Component);
	
	    function ModelSelector(props) {
	        _classCallCheck(this, ModelSelector);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ModelSelector).call(this, props));
	    ...
	    _createClass(ModelSelector, [{
	        ...
	        key: 'renderInputs',
	        value: function renderInputs(element, index) {
...
/***/ function(module, exports) {
	...
	var ColorConverter = function () {
	    ...
	    _createClass(ColorConverter, [{
	        key: 'toRgb',
	        value: function toRgb(colorObject, model) {
	            switch (model) {
	                case 'rgbN':
	        ...
	        key: 'rgbnToRgbb',
	        value: function rgbnToRgbb(colorObject) {
	            return {
	        ...
	        key: 'rgbpToRgbb',
	        value: function rgbpToRgbb(colorObject) {
	            return {
	        ...
	        key: 'rgbhToRgbb',
	        value: function rgbhToRgbb(colorObject) {
	            return {
